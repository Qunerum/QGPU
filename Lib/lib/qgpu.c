...
#define qFontY 11
#define qFontMax 6
static int8_t qFont[159][qFontY][qFontMax] = {
// ===== Full Block , Heart , Arrow Up/Down/Left/Right ======================================================================================================================================
	[128] = {{-18}, {-18}, {-18}, {-18}, {-18}, {-18}, {-18}, {-18}, {-18}, {-18}, {-18}}, // Full block | \x80
	[129] = {{0}, {0}, {0}, {0}, {2, 11, 2, -11}, {1, -16}, {1, -16}, {1, -16}, {2, -14}, {3, -12}, {0}}, // Heart | \x81
	[130] = {{0}, {0}, {0}, {3, -12}, {2, -14}, {1, 11, 1, 12, 1, -11}, {11, 2, 12, 2, -11}, {3, -12}, {3, -12}, {3, -12}, {0}}, // Arrow Up | \x82
	[131] = {{0}, {0}, {0}, {3, -12}, {3, -12}, {3, -12}, {11, 2, 12, 2, -11}, {1, 11, 1, 12, 1, -11}, {2, -14}, {3, -12}, {0}}, // Arrow Down | \x83
	[132] = {{0}, {0}, {0}, {3, -11}, {2, -12}, {1, -12}, {-18}, {1, -12}, {2, -12}, {3, -11}, {0}}, // Arrow Left | \x84
	[133] = {{0}, {0}, {0}, {4, -11}, {4, -12}, {5, -12}, {-18}, {5, -12}, {4, -12}, {4, -11}, {0}}, // Arrow Right | \x85
	[152] = {{0}, {0}, {0}, {2, -14}, {1, -16}, {1, -16}, {1, -16}, {1, -16}, {2, -14}, {0}, {0}}, // Dot | \x98
	[153] = {{0}, {0}, {0}, {1, -16}, {1, 11, 4, -11}, {1, 11, 4, -11}, {1, 11, 4, -11}, {1, 11, 4, -11}, {1, -16}, {0}, {0}}, // Square with a border | \x99
	[154] = {{0}, {0}, {0}, {1, -16}, {1, -16}, {1, -16}, {1, -16}, {1, -16}, {1, -16}, {0}, {0}}, // Square filled | \x9A
	[155] = {{0}, {0}, {0}, {3, -12}, {3, -12}, {2, -14}, {2, -14}, {1, -16}, {1, -16}, {0}, {0}}, // Triangle Up | \x9B
	[156] = {{0}, {0}, {0}, {1, -16}, {1, -16}, {2, -14}, {2, -14}, {3, -12}, {3, -12}, {0}, {0}}, // Triangle Down | \x9C
	[157] = {{0}, {0}, {0}, {5, -12}, {3, -14}, {1, -16}, {1, -16}, {3, -14}, {5, -12}, {0}, {0}}, // Triangle Left | \x9D
	[158] = {{0}, {0}, {0}, {1, -12}, {1, -14}, {1, -16}, {1, -16}, {1, -14}, {1, -12}, {0}, {0}}, // Triangle Right | \x9E
// ===== ! " # $ % & ' ( ) * + , - . / ====================================================================================================================================
...
// ===== a - z ============================================================================================================================================================
	...
	// ===== Ą Ć Ę Ł Ń Ó Ś Ź Ż ================================================================================================================================================
	[134] = {{0}, {0}, {0}, {3, -12}, {2, -14}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, -16}, {1, 12, 2, -12}, {1, 12, 2, -12}, {6, -12}}, // Ą | \x86
	[135] = {{4, -12}, {3, -12}, {0}, {2, -14}, {1, 12, 2, -12}, {1, -12}, {1, -12}, {1, -12}, {1, 12, 2, -12}, {2, -14}, {0}}, // Ć | \x87
	[136] = {{0}, {0}, {0}, {1, -16}, {1, -12}, {1, -12}, {1, -15}, {1, -12}, {1, -12}, {1, -16}, {6, -12}}, // Ę | \x88
	[137] = {{0}, {0}, {0}, {2, -12}, {2, -12}, {2, 14}, {1, -14}, {-14}, {2, -12}, {2, -15}, {0}}, // Ł | \x89
	[138] = {{4, -12}, {3, -12}, {0}, {1, 12, 2, -12}, {1, 13, 1, -12}, {1, -16}, {1, 12, 1, -13}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {0}}, // Ń | \x8A
	[139] = {{4, -12}, {3, -12}, {0}, {2, -14}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {2, -14}, {0}}, // Ó | \x8B
	[140] = {{4, -12}, {3, -12}, {0}, {2, -14}, {1, 12, 2, -12}, {1, -12}, {2, -14}, {5, -12}, {1, 12, 2, -12}, {2, -14}, {0}}, // Ś | \x8C
	[141] = {{4, -12}, {3, -12}, {0}, {1, -16}, {5, -12}, {4, -12}, {3, -12}, {2, -12}, {1, -12}, {1, -16}, {0}}, // Ź | \x8D
	[142] = {{3, -12}, {3, -12}, {0}, {1, -16}, {5, -12}, {4, -12}, {3, -12}, {2, -12}, {1, -12}, {1, -16}, {0}}, // Ż | \x8E
	// ===== ą ć ę ł ń ó ś ź ż ================================================================================================================================================
	[143] = {{0}, {0}, {0}, {0}, {0}, {2, -14}, {5, -12}, {2, -15}, {1, 12, 2, -12}, {2, -15}, {6, -12}}, // ą | \x8F
	[144] = {{0}, {0}, {4, -12}, {3, -12}, {0}, {2, -14}, {1, -12}, {1, -12}, {1, -12}, {2, -14}, {0}}, // ć | \x90
	[145] = {{0}, {0}, {0}, {0}, {0}, {2, -14}, {1, 12, 2, -12}, {1, -16}, {1, -12}, {2, -14}, {5, -12}}, // ę | \x91
	[146] = {{0}, {0}, {0}, {2, -13}, {3, -12}, {3, -13}, {2, -14}, {2, -13}, {3, -12}, {2, -14}, {0}}, // ł | \x92
	[147] = {{0}, {0}, {4, -12}, {3, -12}, {0}, {1, -15}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {0}}, // ń | \x93
	[148] = {{0}, {0}, {4, -12}, {3, -12}, {0}, {2, -14}, {1, 12, 2, -12}, {1, 12, 2, -12}, {1, 12, 2, -12}, {2, -14}, {0}}, // ó | \x94
	[149] = {{0}, {0}, {4, -12}, {3, -12}, {0}, {2, -15}, {1, -12}, {2, -14}, {5, -12}, {1, -15}, {0}}, // ś | \x95
	[150] = {{0}, {0}, {4, -12}, {3, -12}, {0}, {1, -16}, {4, -12}, {3, -12}, {2, -12}, {1, -16}, {0}}, // ź | \x96
	[151] = {{0}, {0}, {3, -12}, {3, -12}, {0}, {1, -16}, {4, -12}, {3, -12}, {2, -12}, {1, -16}, {0}}, // ż | \x97
};
