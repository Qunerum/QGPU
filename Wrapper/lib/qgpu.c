...
QGPU_Char defaultFont[128] = {
    ...
    ['-'] = { .points = { 0.2, 0.5, 0, 0.8, 0.5, 1 }, .pointCount = 2 },
    ['+'] = { .points = { 0.2, 0.5, 0, 0.8, 0.5, 1, 0.5, 0.8, 0, 0.5, 0.2, 1 }, .pointCount = 4 },
    [':'] = { .points = { 0.5, 0.7, 0, 0.5, 0.6, 1, 0.5, 0.2, 0, 0.5, 0.1, 1 }, .pointCount = 4 },
    ['/'] = { .points = { 0.1, 0, 0, 0.9, 1, 1 }, .pointCount = 2 },

    ['0'] = { .points = { 0.2, 0.8, 0, 0.5, 1, 1, 0.8, 0.8, 1, 0.8, 0.2, 1, 0.5, 0, 1, 0.2, 0.2, 1, 0.2, 0.8, 1 }, .pointCount = 7 },
    ['1'] = { .points = { 0.2, 0.7, 0, 0.5, 1, 1, 0.5, 0, 1, 0.2, 0, 0, 0.8, 0, 1 }, .pointCount = 5 },
    ['2'] = { .points = { 0.2, 0.8, 0, 0.5, 1, 1, 0.8, 0.8, 1, 0.2, 0.2, 1, 0.2, 0, 1, 0.8, 0, 1 }, .pointCount = 6 },
    ['3'] = { .points = { 0.2, 1, 0, 0.8, 1, 1, 0.5, 0.5, 1, 0.8, 0.2, 1, 0.5, 0, 1, 0.2, 0, 1 }, .pointCount = 6 },
    ['4'] = { .points = { 0.2, 1, 0, 0.2, 0.5, 1, 0.8, 0.5, 1, 0.8, 1, 0, 0.8, 0, 1 }, .pointCount = 5 },
    ['5'] = { .points = { 0.8, 1, 0, 0.2, 1, 1, 0.2, 0.6, 1, 0.8, 0.5, 1, 0.8, 0.1, 1, 0.5, 0, 1, 0.2, 0, 1 }, .pointCount = 7 },
    ['6'] = { .points = { 0.8, 0.8, 0, 0.5, 1, 1, 0.2, 0.5, 1, 0.8, 0.5, 1, 0.8, 0, 1, 0.2, 0, 1, 0.2, 0.5, 1 }, .pointCount = 7 },
    ['7'] = { .points = { 0.2, 1, 0, 0.8, 1, 1, 0.4, 0, 1 }, .pointCount = 3 },
    ['8'] = { .points = { 0.5, 0.5, 0, 0.2, 0.7, 1, 0.5, 1, 1, 0.8, 0.7, 1, 0.5, 0.5, 1, 0.2, 0.3, 1, 0.5, 0, 1, 0.8, 0.3, 1, 0.5, 0.5, 1 }, .pointCount = 9 },
    ['9'] = { .points = { 0.2, 0.5, 0, 0.8, 0.5, 1, 0.8, 1, 1, 0.2, 1, 1, 0.2, 0.5, 1, 0.8, 0.2, 0, 0.5, 0, 1, 0.2, 0.2, 1 }, .pointCount = 8 },

    // ===== WIELKIE LITERY (Złagodzone krawędzie i łuki) =====
    ['A'] = { .points = { 0.5, 1, 1, 1, 0, 1, 0.15, 0.3, 0, 0.85, 0.3, 1 }, .pointCount = 4 },
    ['B'] = { .points = { 0, 1, 1, 0.7, 1, 1, 0.85, 0.85, 1, 0.7, 0.7, 1, 0, 0.7, 1, 0.7, 0.7, 0, 0.85, 0.5, 1, 0.7, 0, 1, 0, 0, 1, 0, 1, 1 }, .pointCount = 10 },
    ['C'] = { .points = { 0.85, 0.85, 0, 0.5, 1, 1, 0.15, 0.85, 1, 0.15, 0.15, 1, 0.5, 0, 1, 0.85, 0.15, 1 }, .pointCount = 6 },
    ['D'] = { .points = { 0, 1, 1, 0.6, 1, 1, 0.9, 0.75, 1, 0.9, 0.25, 1, 0.6, 0, 1, 0, 0, 1, 0, 1, 1 }, .pointCount = 7 },
    ['E'] = { .points = { 0.85, 1, 0, 0, 1, 1, 0, 0, 1, 0.85, 0, 1, 0, 0.5, 0, 0.7, 0.5, 1 }, .pointCount = 6 },
    ['F'] = { .points = { 0.85, 1, 0, 0, 1, 1, 0, 0, 1, 0, 0.5, 0, 0.7, 0.5, 1 }, .pointCount = 5 },
    ['G'] = { .points = { 0.85, 0.85, 0, 0.5, 1, 1, 0.15, 0.85, 1, 0.15, 0.15, 1, 0.5, 0, 1, 0.85, 0.15, 1, 0.85, 0.4, 1, 0.6, 0.4, 1 }, .pointCount = 8 },
    ['H'] = { .points = { 0, 1, 1, 0, 0, 1, 0, 0.5, 0, 0.85, 0.5, 1, 0.85, 1, 0, 0.85, 0, 1 }, .pointCount = 6 },
    ['I'] = { .points = { 0.3, 1, 0, 0.7, 1, 1, 0.5, 1, 0, 0.5, 0, 1, 0.3, 0, 0, 0.7, 0, 1 }, .pointCount = 6 },
    ['J'] = { .points = { 0.5, 1, 0, 0.85, 1, 1, 0.85, 0.2, 1, 0.5, 0, 1, 0.15, 0.2, 1 }, .pointCount = 5 },
    ['K'] = { .points = { 0, 1, 1, 0, 0, 1, 0, 0.4, 0, 0.85, 1, 1, 0, 0.4, 0, 0.85, 0, 1 }, .pointCount = 6 },
    ['L'] = { .points = { 0, 1, 1, 0, 0, 1, 0.85, 0, 1 }, .pointCount = 3 },
    ['M'] = { .points = { 0, 0, 0, 0, 1, 1, 0.5, 0.4, 1, 1, 1, 1, 1, 0, 1 }, .pointCount = 5 },
    ['N'] = { .points = { 0, 0, 0, 0, 1, 1, 0.85, 0, 1, 0.85, 1, 1 }, .pointCount = 4 },
    ['O'] = { .points = { 0.5, 1, 0, 0.85, 0.85, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1, 0.15, 0.85, 1, 0.5, 1, 1 }, .pointCount = 9 },
    ['P'] = { .points = { 0, 0, 0, 0, 1, 1, 0.7, 1, 1, 0.85, 0.8, 1, 0.7, 0.5, 1, 0, 0.5, 1 }, .pointCount = 6 },
    ['Q'] = { .points = { 0.5, 1, 0, 0.85, 0.85, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1, 0.15, 0.85, 1, 0.5, 1, 1, 0.6, 0.3, 0, 0.9, 0, 1 }, .pointCount = 11 },
    ['R'] = { .points = { 0, 0, 0, 0, 1, 1, 0.7, 1, 1, 0.85, 0.8, 1, 0.7, 0.5, 1, 0, 0.5, 1, 0.5, 0.5, 0, 0.85, 0, 1 }, .pointCount = 8 },
    ['S'] = { .points = { 0.85, 0.8, 0, 0.6, 1, 1, 0.3, 1, 1, 0.15, 0.75, 1, 0.5, 0.5, 1, 0.85, 0.3, 1, 0.6, 0, 1, 0.15, 0.2, 1 }, .pointCount = 8 },
    ['T'] = { .points = { 0.1, 1, 0, 0.9, 1, 1, 0.5, 1, 0, 0.5, 0, 1 }, .pointCount = 4 },
    ['U'] = { .points = { 0.15, 1, 0, 0.15, 0.2, 1, 0.5, 0, 1, 0.85, 0.2, 1, 0.85, 1, 1 }, .pointCount = 5 },
    ['V'] = { .points = { 0.1, 1, 0, 0.5, 0, 1, 0.9, 1, 1 }, .pointCount = 3 },
    ['W'] = { .points = { 0.05, 1, 0, 0.25, 0, 1, 0.5, 0.5, 1, 0.75, 0, 1, 0.95, 1, 1 }, .pointCount = 5 },
    ['X'] = { .points = { 0.1, 1, 0, 0.9, 0, 1, 0.1, 0, 0, 0.9, 1, 1 }, .pointCount = 4 },
    ['Y'] = { .points = { 0.1, 1, 0, 0.5, 0.5, 1, 0.9, 1, 0, 0.5, 0.5, 1, 0.5, 0, 1 }, .pointCount = 5 },
    ['Z'] = { .points = { 0.15, 1, 0, 0.85, 1, 1, 0.15, 0, 1, 0.85, 0, 1 }, .pointCount = 4 },

    // ===== MAŁE LITERY (Wysokość x-height ustawiona z reguły wokół 0.5 - 0.6) =====
    ['a'] = { .points = { 0.15, 0.5, 0, 0.75, 0.5, 1, 0.85, 0.4, 1, 0.85, 0, 1, 0.85, 0.2, 0, 0.15, 0.2, 1, 0.15, 0.4, 1, 0.75, 0.5, 1 }, .pointCount = 8 },
    ['b'] = { .points = { 0.15, 1, 0, 0.15, 0, 1, 0.7, 0, 1, 0.85, 0.15, 1, 0.85, 0.4, 1, 0.7, 0.5, 1, 0.15, 0.5, 1 }, .pointCount = 7 },
    ['c'] = { .points = { 0.8, 0.4, 0, 0.5, 0.5, 1, 0.2, 0.35, 1, 0.2, 0.15, 1, 0.5, 0, 1, 0.8, 0.1, 1 }, .pointCount = 6 },
    ['d'] = { .points = { 0.85, 1, 0, 0.85, 0, 1, 0.3, 0, 1, 0.15, 0.15, 1, 0.15, 0.4, 1, 0.3, 0.5, 1, 0.85, 0.5, 1 }, .pointCount = 7 },
    ['e'] = { .points = { 0.15, 0.25, 0, 0.85, 0.25, 1, 0.85, 0.4, 1, 0.5, 0.5, 1, 0.15, 0.35, 1, 0.15, 0.15, 1, 0.5, 0, 1, 0.85, 0, 1 }, .pointCount = 8 },
    ['f'] = { .points = { 0.3, 0.5, 0, 0.7, 0.5, 1, 0.5, 0.5, 0, 0.5, 0.9, 1, 0.7, 1, 1, 0.5, 0.9, 0, 0.5, 0, 1 }, .pointCount = 7 },
    ['g'] = { .points = { 0.85, 0.5, 0, 0.85, -0.3, 1, 0.4, -0.5, 1, 0.15, -0.3, 1, 0.15, 0.1, 0, 0.4, 0.5, 1, 0.85, 0.5, 1, 0.85, 0.1, 0, 0.15, 0.1, 1 }, .pointCount = 9 },
    ['h'] = { .points = { 0.15, 1, 0, 0.15, 0, 1, 0.15, 0.3, 0, 0.5, 0.5, 1, 0.85, 0.3, 1, 0.85, 0, 1 }, .pointCount = 6 },
    ['i'] = { .points = { 0.5, 0.5, 0, 0.5, 0, 1, 0.5, 0.7, 0, 0.5, 0.8, 1 }, .pointCount = 4 },
    ['j'] = { .points = { 0.6, 0.5, 0, 0.6, -0.4, 1, 0.2, -0.5, 1, 0.6, 0.7, 0, 0.6, 0.8, 1 }, .pointCount = 5 },
    ['k'] = { .points = { 0.15, 1, 0, 0.15, 0, 1, 0.15, 0.25, 0, 0.75, 0.5, 1, 0.15, 0.25, 0, 0.8, 0, 1 }, .pointCount = 6 },
    ['l'] = { .points = { 0.5, 1, 0, 0.5, 0, 1 }, .pointCount = 2 },
    ['m'] = { .points = { 0.15, 0.5, 0, 0.15, 0, 1, 0.15, 0.35, 0, 0.45, 0.5, 1, 0.45, 0, 1, 0.45, 0.35, 0, 0.8, 0.5, 1, 0.8, 0, 1 }, .pointCount = 8 },
    ['n'] = { .points = { 0.15, 0.5, 0, 0.15, 0, 1, 0.15, 0.35, 0, 0.5, 0.5, 1, 0.85, 0.35, 1, 0.85, 0, 1 }, .pointCount = 6 },
    ['o'] = { .points = { 0.5, 0.5, 0, 0.8, 0.4, 1, 0.8, 0.1, 1, 0.5, 0, 1, 0.2, 0.1, 1, 0.2, 0.4, 1, 0.5, 0.5, 1 }, .pointCount = 7 },
    ['p'] = { .points = { 0.15, 0.5, 0, 0.15, -0.4, 1, 0.15, 0.3, 0, 0.5, 0.5, 1, 0.85, 0.4, 1, 0.85, 0.1, 1, 0.5, 0, 1, 0.15, 0.1, 1 }, .pointCount = 8 },
    ['q'] = { .points = { 0.85, 0.5, 0, 0.85, -0.4, 1, 0.85, 0.3, 0, 0.5, 0.5, 1, 0.15, 0.4, 1, 0.15, 0.1, 1, 0.5, 0, 1, 0.85, 0.1, 1 }, .pointCount = 8 },
    ['r'] = { .points = { 0.2, 0.5, 0, 0.2, 0, 1, 0.2, 0.3, 0, 0.5, 0.5, 1, 0.8, 0.5, 1 }, .pointCount = 5 },
    ['s'] = { .points = { 0.8, 0.4, 0, 0.3, 0.5, 1, 0.7, 0.25, 1, 0.2, 0.1, 1 }, .pointCount = 4 },
    ['t'] = { .points = { 0.4, 0.5, 0, 0.8, 0.5, 1, 0.5, 0.8, 0, 0.5, 0.1, 1, 0.7, 0, 1 }, .pointCount = 5 },
    ['u'] = { .points = { 0.15, 0.5, 0, 0.15, 0.1, 1, 0.5, 0, 1, 0.85, 0.1, 1, 0.85, 0.5, 0, 0.85, 0, 1 }, .pointCount = 6 },
    ['v'] = { .points = { 0.15, 0.5, 0, 0.5, 0, 1, 0.85, 0.5, 1 }, .pointCount = 3 },
    ['w'] = { .points = { 0.1, 0.5, 0, 0.3, 0, 1, 0.5, 0.3, 1, 0.7, 0, 1, 0.9, 0.5, 1 }, .pointCount = 5 },
    ['x'] = { .points = { 0.2, 0.5, 0, 0.8, 0, 1, 0.2, 0, 0, 0.8, 0.5, 1 }, .pointCount = 4 },
    ['y'] = { .points = { 0.15, 0.5, 0, 0.5, 0, 1, 0.85, 0.5, 0, 0.85, -0.3, 1, 0.4, -0.5, 1, 0.15, -0.4, 1 }, .pointCount = 6 },
    ['z'] = { .points = { 0.2, 0.5, 0, 0.8, 0.5, 1, 0.2, 0, 1, 0.8, 0, 1 }, .pointCount = 4 }
};
