...
QGPU_Char defaultFont[128] = {
    ...
    ['C'] = { .points = { 1, 1, 0, 0.3, 0.9, 1, 0, 0.5, 1, 0.3, 0.1, 1, 1, 0, 1 }, .pointCount = 5 },
    ['D'] = { .points = { 0, 1, 1, 0.7, 0.9, 1, 1, 0.5, 1, 0.7, 0.1, 1, 0, 0, 1 }, .pointCount = 5 },
    ['E'] = { .points = { 0, 1, 1, 1, 1, 1, 0, 0.5, 0, 0.75, 0.5, 1, 0, 0, 0, 1, 0, 1 }, .pointCount = 6 },
    ['F'] = { .points = { 0, 1, 1, 1, 1, 1, 0, 0.5, 0, 0.75, 0.5, 1 }, .pointCount = 4 },
    ['G'] = { .points = { 1, 1, 0, 0.3, 0.9, 1, 0, 0.5, 1, 0.3, 0.1, 1, 1, 0, 1, 1, 0.5, 1, 0.5, 0.5, 1 }, .pointCount = 7 },
    ...
    ['J'] = { .points = { 0.7, 0.1, 1, 1, 0.5, 1, 1, 1, 1, 0, 1, 1 }, .pointCount = 4 },
