...
QGPU_Char defaultFont[128] = {
    ...
    ['4'] = { .points = { 0.75, 0, 0, 0.75, 1, 1, 0, 0.25, 1, 1, 0.25, 1 }, .pointCount = 4 },
    ['5'] = { .points = { 1, 1, 0, 0, 1, 1, 0, 0.5, 1,  0.75, 0.5, 1, 1, 0.25, 1, 0.75, 0, 1, 0.25, 0, 1, 0, 0.25, 1 }, .pointCount = 8 },
    ...
    ['D'] = { .points = { 0, 1, 1, 0.5, 1, 1, 0.85, 0.85, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0, 0, 1 }, .pointCount = 7 },
    ['E'] = { .points = { 0, 1, 1, 1, 1, 1, 0, 0.5, 0, 0.75, 0.5, 1, 0, 0, 0, 1, 0, 1 }, .pointCount = 6 },
    ['F'] = { .points = { 0, 1, 1, 1, 1, 1, 0, 0.5, 0, 0.75, 0.5, 1 }, .pointCount = 4 },
    ['G'] = { .points = { 0.5, 0.5, 0, 1, 0.5, 1, 1, 0, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1, 0.15, 0.85, 1, 0.5, 1, 1, 1, 1, 1 }, .pointCount = 9 },
    ['H'] = { .points = { 0, 1, 1, 0, 0.5, 0, 1, 0.5, 1, 1, 0, 0, 1, 1, 1 }, .pointCount = 5 },
    ['I'] = { .points = { 0.25, 1, 0, 0.75, 1, 1, 0.5, 1, 0, 0.5, 0, 1, 0.25, 0, 0, 0.75, 0, 1 }, .pointCount = 6 },
    ['J'] = { .points = { 0, 1, 0, 1, 1, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1 }, .pointCount = 7 },
    ['K'] = { .points = { 0, 1, 1, 1, 1, 0, 0, 0.5, 1, 1, 0, 1 }, .pointCount = 4 },
    ['L'] = { .points = { 0, 1, 0, 0, 0, 1, 1, 0, 1 }, .pointCount = 3 },
    ['M'] = { .points = { 0, 1, 1, 0.5, 0.3, 1, 1, 1, 1, 1, 0, 1 }, .pointCount = 4 },
    ['N'] = { .points = { 0, 1, 1, 1, 0, 1, 1, 1, 1 }, .pointCount = 3 },
    ['O'] = { .points = { 0.5, 1, 0, 0.85, 0.85, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1, 0.15, 0.85, 1, 0.5, 1, 1 }, .pointCount = 9 },
    ['P'] = { .points = { 0, 1, 1, 0.5, 1, 1, 0.85, 0.75, 1, 0.5, 0.5, 1, 0, 0.5, 1 }, .pointCount = 5 },
    ['Q'] = { .points = { 0.5, 1, 0, 0.85, 0.85, 1, 1, 0.5, 1, 0.85, 0.15, 1, 0.5, 0, 1, 0.15, 0.15, 1, 0, 0.5, 1, 0.15, 0.85, 1, 0.5, 1, 1, 0.6, 0.4, 0, 1, 0, 1 }, .pointCount = 11 },
    ['R'] = { .points = { 0, 1, 1, 0.5, 1, 1, 0.85, 0.75, 1, 0.5, 0.5, 1, 0, 0.5, 0, 0.5, 0.5, 1, 1, 0, 1 }, .pointCount = 7 },
    ['S'] = { .points = { 1, 0.85, 0, 0.85, 1, 1, 0.15, 1, 1, 0, 0.85, 1, 0, 0.65, 1, 0.15, 0.5, 1, 0.85, 0.5, 1, 1, 0.35, 1, 1, 0.15, 1, 0.85, 0, 1, 0.15, 0, 1, 0, 0.15, 1 }, .pointCount = 12 },
    ['T'] = { .points = { 0, 1, 0, 1, 1, 1, 0.5, 1, 0, 0.5, 0, 1 }, .pointCount = 4 },
    ['U'] = { .points = { 0, 1, 0, 0, 0.5, 1, 0.15, 0.15, 1, 0.5, 0, 1, 0.85, 0.15, 1, 1, 0.5, 1, 1, 1, 1 }, .pointCount = 7 },
    ['V'] = { .points = { 0, 1, 0, 0.5, 0, 1, 1, 1, 1 }, .pointCount = 3 },
    ['W'] = { .points = { 0, 1, 0, 0.15, 0, 1, 0.5, 0.5, 1, 0.85, 0, 1, 1, 1, 1 }, .pointCount = 5 },
    ['X'] = { .points = { 1, 1, 1, 0, 1, 0, 1, 0, 1 }, .pointCount = 3 },
    ['Y'] = { .points = { 0, 1, 0, 0.5, 0.5, 1, 1, 1, 1, 0.5, 0.5, 0, 0.5, 0, 1 }, .pointCount = 5 },
    ['Z'] = { .points = { 0, 1, 0, 1, 1, 1, 0, 0, 1, 1, 0, 1 }, .pointCount = 4 }
};
